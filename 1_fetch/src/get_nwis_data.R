...
# Save output as CSV
download_nwis_site_data <- function(fileout, site_num, parameterCd = '00010', startDate="2014-05-01", endDate="2015-05-01"){
...
combine_csvs <- function(filein){
  lapply(filein, read_csv, show_col_types = FALSE) %>% 
    bind_rows()
}
